...
def sendmail(to,content):
    ...
    server.login("<<YOUR EMAILID>>","<<YOUR PASSWORD>>")
...
def screenshot():
    ...
    img.save("D:/Assistant/ss.png")#Create a folder in directory
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # to open system apps
            ...
            subprocess.Popen('C:\\Windows\\System32\\write.exe') #write your app location here
        elif 'notepad' in query:
            speak("Opening notepad")
            subprocess.Popen('C:\\Windows\\System32\\notepad.exe') #write your app location here
        elif 'calculator' in query:
            speak("Opening calculator")
            subprocess.Popen('C:\\Windows\\System32\\calc.exe') #write your app location here
        elif 'word' in query:
            speak("Opening word")
            subprocess.Popen("C:\\Program Files\\Microsoft Office\\root\\Office16\\WINWORD.EXE") #write your app location here
        elif 'powerpoint' in query:
            speak("Opening powerpoint")
            subprocess.Popen("C:\\Program Files\\Microsoft Office\\root\\Office16\\POWERPNT.EXE") #write your app location here
        elif 'excel' in query:
            speak("Opening excel")
            subprocess.Popen("C:\\Program Files\\Microsoft Office\\root\\Office16\\EXCEL.EXE") #write your app location here
        elif 'photoshop' in query:
            speak("Opening photoshop")
            subprocess.Popen("C:\\Program Files (x86)\\Adobe\\Photoshop 7.0\\Photoshop.exe") #write your app location here
